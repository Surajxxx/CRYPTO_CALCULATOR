...
const httpErrorMsgs = {
    ...
    BASE_CURRENCY_ERROR_MSG: "Base currency is required and should be from: btc, eth, ltc, bnb, sol",
    QUOTE_CURRENCY_ERROR_MSG: "Quote currency is required and should be from:  btc, eth, ltc, bnb, sol ",
